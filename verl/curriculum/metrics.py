...
"""
Curriculum learning metric calculations for sample difficulty assessment.
"""
...
def calculate_distinct_n(tokenized_sequences, n=3):
    """Calculate distinct-n score (diversity metric) using model's tokenized sequences."""
...
def calculate_learnability_metric(reward_fn, batch, batch_size, curriculum_rollout_n):
    """Calculate learnability metric based on reward accuracy."""
